...
export const Menu = component$(() => {
    ...
    return(
      ...
      <Link id="search" href="/search"  class={mutable(`flex flex-row-reverse items-center content-center space-x-3 px-2 mx-1 md:mx-2  py-3 lg:py-[8px] ${loc.pathname==='/search'?'selected-sidebar-bg selected-sidebar-text selected-sidebar-icon':'unselected-sidebar-bg unselected-sidebar-text unselected-sidebar-icon'}`)}>
      ...
      <Link id="clips" href="/clips"  class={mutable(`flex flex-row-reverse items-center content-center space-x-3 px-2 mx-1 md:mx-2  py-3 lg:py-[8px] ${loc.pathname==='/clips'?'selected-sidebar-bg selected-sidebar-text selected-sidebar-icon':'unselected-sidebar-bg unselected-sidebar-text unselected-sidebar-icon'}`)}>
      ...
      <Link id="favourites" href="/favs"  class={mutable(`flex flex-row-reverse items-center content-center space-x-3 px-2  mx-1 md:mx-2  py-3 lg:py-[8px] ${loc.pathname==='/favs'?'selected-sidebar-bg selected-sidebar-text selected-sidebar-icon':'unselected-sidebar-bg unselected-sidebar-text unselected-sidebar-icon'}`)}>
      ...
      <Link id="settings" href="/settings"  class={mutable(`flex  md:mt-auto ml-auto flex-row-reverse items-center content-center space-x-3 px-2  mx-1 mr-[6px] md:mx-2  py-3 lg:py-[8px] ${loc.pathname==='/settings'?'selected-sidebar-bg selected-sidebar-text selected-sidebar-icon':'unselected-sidebar-bg unselected-sidebar-text unselected-sidebar-icon'}`)}>
