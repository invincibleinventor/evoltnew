...
<span class="xl:text-lg  mx-auto  xl:mx-0 text-lg font-semibold font-sf text-neutral-300"></span>
<span class="xl:text-[12.5px]  mt-1  xl:mt-[0px] text-center xl:text-left leading-relaxed xl:px-0 xl:w-full sm:w-3/4 leading-5 xl:mx-0 mx-auto px-8 text-[12px]  font-sf text-neutral-400"></span>
</div>
</div>
